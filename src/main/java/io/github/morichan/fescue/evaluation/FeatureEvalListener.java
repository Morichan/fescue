 ...
 *
 * <p>
 *     {@link io.github.morichan.fescue.parser.ClassFeatureBaseListener}およびそのクラスを自動生成するANTLRに依存します。
 * </p>
 */
public class FeatureEvalListener extends io.github.morichan.fescue.parser.ClassFeatureBaseListener {
    /**
     * 属性文コンテキスト
     */
