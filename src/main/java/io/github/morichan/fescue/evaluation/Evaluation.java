...
public interface Evaluation {
     ...
     *     GeneratedParser jp.ac.miyazaki_u.cs.earth.io.github.morichan.fescue.parser = new GeneratedParser(tokens);
     *     // パーサの任意のコンテキストを頂点とする構文木を取得します。
     *     ParseTree tree = jp.ac.miyazaki_u.cs.earth.io.github.morichan.fescue.parser.anyContext();
     *     // 構文木走査器を作ります。
