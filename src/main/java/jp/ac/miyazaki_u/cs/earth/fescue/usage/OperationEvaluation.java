package jp.ac.miyazaki_u.cs.earth.fescue.usage;

import jp.ac.miyazaki_u.cs.earth.fescue.evaluation.FeatureEvalListener;
import jp.ac.miyazaki_u.cs.earth.fescue.evaluation.FeatureEvaluation;
 ...
 *     {@link jp.ac.miyazaki_u.cs.earth.fescue.sculptor.OperationSculptor}クラスをご利用ください。
 * </p>
 *
 * <p> 簡単な使い方を次に示します。</p>
 *
 * <pre>
 *     {@code
 *     OperationEvaluation jp.ac.miyazaki_u.cs.earth.fescue.evaluation = new OperationEvaluation();
 *     jp.ac.miyazaki_u.cs.earth.fescue.evaluation.setText("+ operation() : double");
 *     jp.ac.miyazaki_u.cs.earth.fescue.evaluation.walk();
 *
 *     String name = jp.ac.miyazaki_u.cs.earth.fescue.evaluation.extractName();
 *     String visibility = jp.ac.miyazaki_u.cs.earth.fescue.evaluation.extractVisibility();
 *     String returnType = jp.ac.miyazaki_u.cs.earth.fescue.evaluation.extractReturnType();
 *     // ...
 *     }
 * </pre>
 *
