...
import jp.ac.miyazaki_u.cs.earth.fescue.evaluation.OperationEvaluation;
import jp.ac.miyazaki_u.cs.earth.fescue.feature.Operation;
import jp.ac.miyazaki_u.cs.earth.fescue.feature.direction.*;
...
import jp.ac.miyazaki_u.cs.earth.fescue.feature.value.expression.symbol.Symbol;
 ...
 *
 * <p>
 *     操作文を入力することで、{@link jp.ac.miyazaki_u.cs.earth.fescue.feature.Operation}クラスのインスタンス化を行います。
 * </p>
 *
 * <pre>
 *     {@code
...
public class OperationSculptor {
    ...
    /**
     * <p> 操作文コンテキストから{@link jp.ac.miyazaki_u.cs.earth.fescue.feature.Operation}インスタンスを形成します。 </p>
     *
