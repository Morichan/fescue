 ...
 *
 * <p>
 *     {@link jp.ac.miyazaki_u.cs.earth.fescue.parser.ClassFeatureBaseListener}およびそのクラスを自動生成するANTLRに依存します。
 * </p>
 */
public class FeatureEvalListener extends jp.ac.miyazaki_u.cs.earth.fescue.parser.ClassFeatureBaseListener {
    /**
     * 属性文コンテキスト
     */
